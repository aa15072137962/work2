...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <%--<form class="form-horizontal"  action="${pageContext.request.contextPath}/product/add"
              method="post">--%>
        <!-- 正文区域 -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <!-- 水平排列的表单需要在form标签上加入 form-horizontal -->
                    <form class="form-horizontal" action="${pageContext.request.contextPath}/product/add"
                          method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10 ">
                                <input type="text" class="form-control" placeholder="其他信息" name="productDesc" value="">
                            </div>
                        </div>
